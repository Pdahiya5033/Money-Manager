...
public class MessageRVAdapter extends RecyclerView.Adapter {
    ...
    //constructor class.
    public MessageRVAdapter(ArrayList<ChatsModel> messageModalArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (modal.getSender()) {
            case "user":
                ...
                ((UserViewHolder) holder).userTV.setText(modal.getMsg());
                break;
            case "bot":
                //below line is to set the text to our text view of bot layout
                ((BotViewHolder) holder).botTV.setText(modal.getMsg());
                break;
        }
    }
